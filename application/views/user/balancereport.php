...
************* -->
	...
	<div class="content-wrapper">
		<!-- Row start -->
		<div class="card-body">
			<form method="post" action="<?php  echo base_url(); ?>BalanceReport/index">
				<div class="row gutters">
					<div class="col-xl-4 col-lg-3 col-md-3 col-sm-3 col-12">
						<div class="form-group">
							...
							<input type="date"  name="datefrom" value='<?php echo set_value('datefrom'); ?>' class="form-control" id="inputName" style=" font-size:15px;font-weight:bold;">
						</div>
					</div>
					<div class="col-xl-4 col-lg-3 col-md-3 col-sm-3 col-12">
						<div class="form-group">
							...
							<input type="date" name="dateto" value='<?php echo set_value('dateto'); ?>'  class="form-control" id="inputName" style=" font-size:15px;font-weight:bold;">
						</div>
					</div>
					<div class="col-xl-4 col-lg-3 col-md-3 col-sm-3 col-12">
						<div class="form-group">
		...
		foreach ($passbook->result() as $row)
    {
		?>
								<tr>
									...
									<td><?php echo getUserNameById($row->datafrom);  ?>/<?php if($row->datato){ echo getUserNameById($row->datato); } ?></td>
