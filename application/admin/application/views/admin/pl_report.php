	...
	<div class="content-wrapper">
		<!-- Row start -->
		<div class="card-body">
			<form method="post" action="<?php echo base_url();?>AdminPlReport/index">
   	...
   	if($_SESSION['access_level']==4){
		...
		?>
								<tr>
									...
									<a href="javascript:void(0);" class="CancleData"  data-id="<?php echo $row->ticket_id; ?>"
									
									
									data-ticket="<?php echo $row->ticket_id; ?>"
								...
								?>
									...
									IF($custmeridPART>0){ echo $row->ticket_win_amount-($row->ticket_win_amount*$custmeridPART/100); }ELSE{ ECHO $row->ticket_win_amount; } ?></td>
								
								 
								   <!--  <td><?php echo $row->total_com;  ?></td>
								     <td><?php echo $row->afterpatnership;  ?></td>
...
if($row->game_patti_type=='AAKDA-001'){
                ...
                <div class="table-responsive">
									<table id="basicExample" class="table m-0">
										<thead>
		<?php 
			$aakd_data=gameDataByBazar($row->ticket_id,$row->game_patti_type,$row->customer_id,$custmeridPART);
