...
$resultopenData=getResult($bazarid,'open',$currentDate);
  ...
  if(empty($openpanaResult) and empty($closepanaResult)){
	...
	<h6 style="color:#342e36;font-size:17px;">Bids : <?php echo getBazarActiveData2($bazarid,'open');  ?> <span style="color:white; font-size: 14px;"><?php  ?></span>&nbsp;|&nbsp;Bids : <?php echo getBazarActiveData2($bazarid,'close'); ?><span style="color:white; font-size: 14px;"><?php  ?></span></h6>
													</div>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<div class="card-header" style="text-align:center;" >
						...
						<a href="<?php echo base_url('Admin/mastergame');?>"class="badge badge-pill badge-info"style="font-size: 22px; font-weight: 900;color: white;height:40px;text-align:center;">
						    <i class="icon-import_contacts"></i>  &nbsp; PLAY NOW</a>
					</div>
					</div>
					</div>
