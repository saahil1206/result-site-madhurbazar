...
foreach ($resultdata->result() as $row)
{
                            ...
                            <tr>
									...
									<th><?php echo $row->createdby;  ?></th>
									<th><a href="<?php echo base_url();?>GameResult/revoke/<?php  echo $row->id; ?>"><button class="btn btn-danger">Delete</button></a>
									<a href="<?php echo base_url();?>GameResult/edit/<?php  echo $row->id; ?>"><button class="btn btn-primary">Edit</button></a></th>
