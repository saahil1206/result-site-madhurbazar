...
************* -->
	...
	<div class="content-wrapper">
		...
		?>
			...
			<br><br>
						<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input" <?php if(set_value('timeupdate')){ echo'checked' ;} ?> name='timeupdate'   id="customSwitch8">
						...
						<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input" <?php if(set_value('editresult')){ echo'checked' ;} ?> name='editresult'   id="customSwitch9">
						...
						<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input" <?php if(set_value('noticeupdate')){ echo'checked' ;} ?> name='noticeupdate'   id="customSwitch10">
						...
						<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input" <?php if(set_value('higlightbazar')){ echo'checked' ;} ?> name='higlightbazar' id="customSwitch11">
						...
						<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input" <?php if(set_value('listbazar')){ echo'checked' ;} ?> name='listbazar'  id="customSwitch12">
						...
						<div class="row gutters">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
								...
								<div class="form-group">
									...
									<input class="form-control"   id="notice" type="text" name="notice"style="font-weight: bold;font-size: 15px;" >
								</div>
